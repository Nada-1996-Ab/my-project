...
class drawer_needycontroller extends StatefulWidget {
  const drawer_needycontroller({
    Key key,
  ...
  final Function(DrawerIndexNedded) onDrawerCall;
  ...
  @override
  _drawer_needycontrollerState createState() => _drawer_needycontrollerState();
}

class _drawer_needycontrollerState extends State<drawer_needycontroller> with TickerProviderStateMixin {
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (BuildContext context, Widget child) {
                    return Transform(
                      ...
                      child: needy_homedrawer(
                        screenIndex: widget.screenIndex == null ? DrawerIndexNedded.HOME : widget.screenIndex,
                        iconAnimationController: iconAnimationController,
                        callBackIndex: (DrawerIndexNedded indexType) {
                          onDrawerClick();
                          try {
