...
class needy_homedrawer extends StatefulWidget {
  const needy_homedrawer({Key key, this.screenIndex, this.iconAnimationController, this.callBackIndex}) : super(key: key);

  final AnimationController iconAnimationController;
  final DrawerIndexNedded screenIndex;
  final Function(DrawerIndexNedded) callBackIndex;

  @override
  _needy_homedrawerState createState() => _needy_homedrawerState();
}

class _needy_homedrawerState extends State<needy_homedrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = <DrawerList>[
      DrawerList(
        index: DrawerIndexNedded.HOME,
        labelName: 'Home',
        icon: Icon(Icons.home),
      ),
      DrawerList(
        index: DrawerIndexNedded.Orders,
        labelName: 'My Orders',
        icon: Icon(Icons.shopping_cart),
      ),
      DrawerList(
        index: DrawerIndexNedded.Profile,
        labelName: "Profile",
        icon: Icon(Icons.person),
      ),
      DrawerList(
        index: DrawerIndexNedded.Help,
        labelName: 'Help',
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    children: <Widget>[
                      Text(
                        "Welcome To "+user.userModel?.name ?? "User Name",
                        style: TextStyle(
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return
                      CheckDialog(
                        title: "Sign Out",
                        content: "are you want to sign out",
                        pressYes: () async {
                          await user.signOut();
  ...
  Future<void> navigationtoScreen(DrawerIndexNedded indexScreen) async {
    widget.callBackIndex(indexScreen);
  }
}

enum DrawerIndexNedded {
  HOME,
  Profile,
  Help,
  About,
