...
class donor_homedrawer extends StatefulWidget {
  const donor_homedrawer({Key key, this.screenIndex, this.iconAnimationController, this.callBackIndex}) : super(key: key);
  ...
  @override
  _donor_homedrawerState createState() => _donor_homedrawerState();
}

class _donor_homedrawerState extends State<donor_homedrawer> {
