...
class drawer_donorcontroller extends StatefulWidget {
  const drawer_donorcontroller({
    Key key,
  ...
  @override
  _drawer_donorcontrollerState createState() => _drawer_donorcontrollerState();
}

class _drawer_donorcontrollerState extends State<drawer_donorcontroller> with TickerProviderStateMixin {
